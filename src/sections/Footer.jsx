...
const Footer = () => {
  return (
    <footer className="max-container">
            ...
            <div className="flex items-center gap-5 mt-8">
                {socialMedia.map((icons) =>(
                  <div className="flex justify-center items-center w-12 h-12 bg-white rounded-full cursor-pointer">
                    <img src={icons.src} alt={icons.src} width={24} height={24} />
                  </div>
                ))}
            </div>
        </div>
      ...
      <div className="flex justify-between text-white-400 mt-24 max-sm:flex-col mx-sm:items-center">
        <div className="flex flex-1 justify-start items-center gap-2 font-montserrat cursor-pinter">
